...
export class StagingProdPipelineStack extends cdk.Stack {
  ...
  constructor(
    scope: cdk.App,
    id: string,
    props: StagingProdPipelineStackProps
  ) {
    super(scope, id, {
      ...props,
      //autoDeploy: false,
    ...
    this.nginxBuiltImageStaging = new PipelineContainerImage(
      this.nginxRepository
    );
          ...
          actions: [
            new codepipeline_actions.CloudFormationCreateUpdateStackAction({
              ...
              parameterOverrides: {
                ...
                [this.nginxBuiltImageStaging.paramName]:
                  cdkBuildOutput.getParam("imageTag.json", "imageTag"),
              },
            ...
            new codepipeline_actions.ManualApprovalAction({
              ...
              runOrder: 2,
              notifyEmails: [stagingValidationEmail],
            }),
          ],
        },
        {
          ...
          actions: [
            new codepipeline_actions.CloudFormationCreateUpdateStackAction({
              ...
              parameterOverrides: {
                ...
                [this.nginxBuiltImageProd.paramName]: cdkBuildOutput.getParam(
                  "imageTag.json",
                  "imageTag"
                ),
              },
